...
void frequency_analysis_attack(char *ciphertext, int num_results) {
    ...
    for (int i = 0; i < num_results; i++) {
        printf("%d. Score: %.2f, Shift: %d\n   Plaintext: %s\n\n", i + 1, results[i].score, results[i].shift, results[i].plaintext);
    }
}
int main() {
